...
const STAFF = [
  ...
  { initials: 'LP', name: 'Lucas Pereyra', role: 'Profesor', spec: 'Musculación', srl: './images/staff/profe2.png' },
  { initials: 'VR', name: 'Valeria Romero', role: 'Profesora', spec: 'Spinning y fitness', srl: './images/staff/profe3.png' },
  { initials: 'DG', name: 'Diego González', role: 'Profesor', spec: 'Entrenamiento funcional', srl: './images/staff/profe4.png' },
  { initials: 'SM', name: 'Sofía Méndez', role: 'Profesora', spec: 'Musculación', srl: './images/staff/profe5.png' },
  { initials: 'FT', name: 'Franco Torres', role: 'Profesor', spec: 'Musculación y spinning', srl: './images/staff/profe3.png' },
]
